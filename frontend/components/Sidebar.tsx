        ...
        <aside className="fixed left-0 top-0 bottom-0 w-20 md:w-64 bg-black/90 backdrop-blur-xl border-r border-white/10 flex flex-col z-50">
            ...
            <div className="p-4 border-t border-white/10 space-y-3">
                ...
                <button
                    ...
                    className="flex items-center gap-3 px-4 py-2 text-gray-400 w-full transition-colors font-medium text-xs hover:text-white hover:bg-white/5 rounded-lg justify-center"
                >
