import { Controller, Post, Body, BadRequestException, Request, UseGuards, Headers } from '@nestjs/common';
...
export class PaymentsController {
    ...
    async handleBinanceWebhook(
        ...
        return this.paymentsService.processBinanceWebhook(body, timestamp, nonce, signature);
    }

    @UseGuards(JwtAuthGuard)
    @Post('deposit')
    async createDeposit(@Request() req: any, @Body() body: CreateDepositDto) {
